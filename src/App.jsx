...
const COURSES = [
  { id: "CS", officialCode: "CS757", name: "Corporate Strategy", shortName: "CS", faculty: "Deepak Chandrashekar", area: "Strat", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 150, totalSelected: 220, demandRatio: 1.46, sentiment: "recommended", reviewText: "• Considered the best strategy course of Year 2. Excellent professor. Very useful for placements.\n• Good teachings, good break from C&S. Be prepared to spend heavy bidding points to get a seat.\n• Note: The teaching style is traditional—everything is handwritten on the board, with no PPTs used.", outline: ["Analytical approaches and frameworks in corporate strategy", "How multi-business firms create and appropriate value", "Firm growth, diversification, and vertical integration", "Strategic alliances, joint ventures, and managing outsourcing", "M&A, internationalization, and divestitures"], gradingBreakdown: { "Class participation": "10%", "3 quizzes": "30%", "Group project & presentation": "25%", "End-term exam": "35%" }, sections: [{ id: "CS_GR1", label: "GR1", dayBlock: "MonTue", timeslot: "10:00-11:30", slotIndex: 2, seats: 75, selected: 107, mrb: 36, isDoubleSlot: false }, { id: "CS_GR2", label: "GR2", dayBlock: "MonTue", timeslot: "11:45-13:15", slotIndex: 3, seats: 75, selected: 113, mrb: 231, isDoubleSlot: false }] },
  { id: "AIS", officialCode: "CS772", name: "AI Strategy", shortName: "AIS", faculty: "Vijay Venkataraman", area: "Strat", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 70, totalSelected: 107, demandRatio: 1.52, sentiment: "not_recommended", reviewText: "• The professor is very chill, but it is highly recommended not to take this course.\n• Learning outcomes are low, as it doesn't involve much 'actual' AI content.\n• Quizzes test more VARC skills than actual AIS content. Low standard deviation subject, so grades can be luck-dependent.", outline: ["Economics of AI and implications for future of work", "Predictive and generative power of AI, job redesign strategies", "Risks, biases, and governance challenges of AI"], gradingBreakdown: { "Quiz 1": "10%", "Quiz 2": "10%", "Class Participation": "15%", "Case Analysis": "15%", "Project": "25%", "Final Exam": "25%" }, sections: [{ id: "AIS_1", label: "GR1", dayBlock: "MonTue", timeslot: "10:00-11:30", slotIndex: 2, seats: 70, selected: 107, mrb: 201, isDoubleSlot: false }] },
  { id: "STDM", officialCode: "CS726", name: "Strategic Thinking and Decision Making", shortName: "STDM", faculty: "V.N. Bhattacharya", area: "Strat", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 80, totalSelected: 55, demandRatio: 0.68, sentiment: "caution", reviewText: "• An excellent course taught by an even better professor; the best choice if you are interested in game theory, biases, and psychology.\n• Grading Catch: Grading is highly subjective. The professor will only award marks if your answer perfectly matches his specific line of thought, and he will not negotiate on grades.", outline: ["Rational thinking, Game Theory, simultaneous games", "Prisoners' Dilemma, strategic moves, Added Value"], gradingBreakdown: { "Surprise quizzes (3)": "15%", "Pre-announced Quiz (1)": "20%", "Mid-term examination": "30%", "End term examination": "35%" }, sections: [{ id: "STDM_A", label: "PGP", dayBlock: "FriSat", timeslot: "11:45-13:15", slotIndex: 3, seats: 70, selected: 39, mrb: 0, isDoubleSlot: false }, { id: "STDM_B", label: "PGPEM", dayBlock: "FriSat", timeslot: "14:30-16:00", slotIndex: 4, seats: 10, selected: 16, mrb: 471, isDoubleSlot: false }] },
  ...
  { id: "BE", officialCode: "EC745", name: "Behavioral Economics", shortName: "BE", faculty: "Ritwik Banerjee", area: "Econ", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 130, totalSelected: 121, demandRatio: 0.93, sentiment: "caution", reviewText: "• End-Term exam is relatively easy and is based directly on PPTs and class discussions. Median score is very high.\n• Primary deciding factor for your final grade is the Group Project (40%). For the project, the professor offered no guidance.\n• Warning: Project groups are formed completely randomly by the professor ('decided by God').", outline: ["How decisions are made: Econs vs Humans", "Heuristics, biases, exponential growth bias, overconfidence"], gradingBreakdown: { "Midterm Exam": "30%", "EndTerm Exam": "30%", "Group Project": "40%" }, sections: [{ id: "BE_GR1", label: "GR1", dayBlock: "MonTue", timeslot: "16:15-17:45", slotIndex: 5, seats: 65, selected: 81, mrb: 6, isDoubleSlot: false }, { id: "BE_GR2", label: "GR2", dayBlock: "MonTue", timeslot: "14:30-16:00", slotIndex: 4, seats: 65, selected: 40, mrb: 0, isDoubleSlot: false }] },
  { id: "EDMN", officialCode: "EC753", name: "Economics of Decision-Making and Negotiation", shortName: "EDMN", faculty: "Sarvesh Bandhu", area: "Econ", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 75, totalSelected: 27, demandRatio: 0.36, sentiment: "caution", reviewText: "• Strongly recommended if you have an analytical mindset and prefer game theory logic over rote memorization. Quizzes are the major differentiator for grading.\n• Course structure felt a bit experimental and unorganized last year, but it is easy to survive.\n• Simulation components were highly scorable (answers could previously be found on YouTube).", outline: ["Making more informed decisions, navigating risk and uncertainty", "Identifying and mitigating cognitive biases"], gradingBreakdown: { "Exercises (Quizzes/Simulations)": "40%", "Group Project": "35%", "Assignments": "15%", "Class Participation": "10%" }, sections: [{ id: "EDMN_1", label: "GR1", dayBlock: "MonTue", timeslot: "16:15-17:45", slotIndex: 5, seats: 75, selected: 27, mrb: 0, isDoubleSlot: false }] },
  ...
  { id: "HETP", officialCode: "PP722", name: "Healthcare Economics: Theory and Practice", shortName: "HETP", faculty: "Arnab Mukherji & Allen Ugargol", area: "PP", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 140, totalSelected: 72, demandRatio: 0.51, sentiment: "caution", reviewText: "• Grading is handled entirely by the Teaching Assistants, not the professors.\n• The group project is scored based on the programs and comparisons you propose to improve health outcomes in your chosen state.\n• Reflection Notes (RN) are based on research papers read in class and are very low-stress (many groups use AI tools to assist).", outline: ["Growth Prospects and Challenges for Healthcare in India", "Core Health Economics Concepts"], gradingBreakdown: { "Class Participation": "10%", "Four Reflection Notes (Individual)": "45%", "State of Health Report (Group)": "45%" }, sections: [{ id: "HETP_GR1", label: "GR1", dayBlock: "WedThu", timeslot: "10:00-11:30", slotIndex: 2, seats: 70, selected: 50, mrb: 0, isDoubleSlot: false }, { id: "HETP_GR2", label: "GR2", dayBlock: "WedThu", timeslot: "11:45-13:15", slotIndex: 3, seats: 70, selected: 22, mrb: 0, isDoubleSlot: false }] },
  { id: "IBH", officialCode: "PP754", name: "Indian Business History", shortName: "IBH", faculty: "Rajalaxmi Kamath", area: "PP", anchor: "PGPEM", credits: 3, grading: "Standard", totalSeats: 30, totalSelected: 31, demandRatio: 1.03, sentiment: "recommended", reviewText: "• Very relaxed workload (\"chill course\"). Approachable and easygoing professor. Classes consistently end early, usually by 15-45 mins.\n• Only \"cold calling\" is being asked to read from slides. A good course to take, regardless of active interest in Indian history.\n• Crucial Tip: Professor does not share slides after class, so a good level of attention and note-taking is required.", outline: ["Trade in Pre-Mughal and Mughal times", "East India Company and Indian Business Communities"], gradingBreakdown: { "Primary Source Analysis (Individual)": "50%", "Final Capstone (Group)": "50%" }, sections: [{ id: "IBH_1", label: "GR1", dayBlock: "FriSat", timeslot: "14:30-16:00", slotIndex: 4, seats: 30, selected: 31, mrb: 1, isDoubleSlot: false }] },
  ...
  { id: "GCK", officialCode: "AC702", name: "General Commercial Knowledge", shortName: "GCK", faculty: "Shanker Subramoney", area: "Interdis", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 140, totalSelected: 141, demandRatio: 1.00, sentiment: "recommended", reviewText: "• An absolutely recommended, stress-free course. Funny prof (monotonous voice) and does not restrict phone/device usage.\n• Mid-term and End-term exams are open-slides. Easy MCQs.\n• Pro-tip: Take the printed course binder to class, make notes directly in it, and revise from it before exams.\n• Note: Typically offered again in Term 5/6.", outline: ["Commerce and trade in Indian and International context", "Contractual risk perception and mitigation"], gradingBreakdown: { "Class Participation": "10%", "Group Activity": "25%", "Mid Term": "25%", "End Term": "40%" }, sections: [{ id: "GCK_GR1", label: "GR1", dayBlock: "FriSat", timeslot: "08:00-09:30", slotIndex: 1, seats: 70, selected: 84, mrb: 11, isDoubleSlot: false }, { id: "GCK_GR2", label: "GR2", dayBlock: "FriSat", timeslot: "11:45-13:15", slotIndex: 3, seats: 70, selected: 57, mrb: 0, isDoubleSlot: false }] },
  ...
  { id: "CFS", officialCode: "FI795", name: "Corporate Financial Strategy", shortName: "CFS", faculty: "M Jayadev & Samir Chawla", area: "F&A", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 70, totalSelected: 30, demandRatio: 0.42, sentiment: "not_recommended", reviewText: "• Strongly advised against taking ('big no').\n• Professor Jayadev M has a very old-school, traditional, and strict approach.\n• No phone usage allowed, and the classroom environment lacks humor or engagement.", outline: null, gradingBreakdown: {}, sections: [{ id: "CFS_1", label: "GR1", dayBlock: "FriSat", timeslot: "11:45-13:15", slotIndex: 3, seats: 70, selected: 30, mrb: 0, isDoubleSlot: false }] },
  { id: "VAL", officialCode: "FI734", name: "Valuation", shortName: "VAL", faculty: "Narahari Hansoge", area: "F&A", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 70, totalSelected: 18, demandRatio: 0.25, sentiment: "not_recommended", eligibilityWarning: "If you took Business Valuation Using Financial Statements (BVFS) in Term 3, you ARE eligible for this course.", reviewText: "• Professor is superbly knowledgeable but incredibly strict ('insane' on day 1). Requires massive effort for pre-reads and projects.\n• Strictly grades low, but offers a highly valuable LoR if you finish in the top 25%.\n• Exam papers strictly based on class + YouTube numericals. Sitting in front and taking careful notes is the winning strategy.\n• Sleeping/phones tolerated in regular class, but strictly punished during guest lectures.", outline: ["Valuation mental models, forecasting financial performance", "DCF modeling, cost of capital, growth, uncertainty"], gradingBreakdown: { "Mid-term (Individual)": "25%", "End-term (Individual)": "35%", "Valuation project (Group)": "40%" }, sections: [{ id: "VAL_1", label: "GR1", dayBlock: "WedThu", timeslot: "10:00-11:30", slotIndex: 2, seats: 70, selected: 18, mrb: 0, isDoubleSlot: false }] },
  ...
  { id: "CCBE", officialCode: "PO729", name: "Competition & Cooperation in Ecosystems", shortName: "CCBE", faculty: "Rajeev Tripathi", area: "POM", anchor: "PGP", credits: 3, grading: "Standard", totalSeats: 140, totalSelected: 46, demandRatio: 0.32, sentiment: "recommended", reviewText: "• A great, enjoyable course with genuine learning opportunities. Highly recommended to pair with STDM.\n• Despite workload sheets, it is a very light/chill course. Scoring is relatively easy. First few lectures slow, but gets highly engaging.\n• Exams are numerical-based and manageable. End-Term is very easy, pushing median high (80-90%).\n• Note: Typically offered again in Term 5/6.", outline: ["Business ecosystems and ecosystem strategy", "Competition and cooperation dynamics"], gradingBreakdown: { "Term project": "30%", "Case analysis": "10%", "Quizzes": "20%", "End-term": "40%" }, sections: [{ id: "CCBE_GR1", label: "GR1", dayBlock: "WedThu", timeslot: "11:45-13:15", slotIndex: 3, seats: 70, selected: 35, mrb: 0, isDoubleSlot: false }, { id: "CCBE_GR2", label: "GR2", dayBlock: "WedThu", timeslot: "10:00-11:30", slotIndex: 2, seats: 70, selected: 11, mrb: 0, isDoubleSlot: false }] },
  { id: "RBO", officialCode: "PO735", name: "Responsible Business Operations", shortName: "RBO", faculty: "Rajeev Tripathi", area: "POM", anchor: "PGPEM", credits: 3, grading: "Standard", totalSeats: 100, totalSelected: 11, demandRatio: 0.11, sentiment: "recommended", reviewText: "• The professor is very chill. Zero effort, Globe subject.\n• Heavy focus on theory, sustainability, and ethics in a business context (\"too much globe\").\n• No statistics involved; the math is extremely basic (e.g., simple cross-multiplication in a quiz).", outline: ["SDGs, ESG rating methodologies", "Carbon credit markets, footprint analysis"], gradingBreakdown: { "Case analysis": "10%", "Quizzes": "20%", "Term project": "30%", "End-term": "40%" }, sections: [{ id: "RBO_A", label: "PGP", dayBlock: "FriSat", timeslot: "10:00-11:30", slotIndex: 2, seats: 70, selected: 7, mrb: 0, isDoubleSlot: false }, { id: "RBO_B", label: "PGPEM", dayBlock: "FriSat", timeslot: "14:30-16:00", slotIndex: 4, seats: 30, selected: 4, mrb: 0, isDoubleSlot: false }] },
  ...
  { id: "LWJ", officialCode: "OH707", name: "Leading With Joy", shortName: "LWJ", faculty: "Ramya Ranganathan", area: "OBHRM", anchor: "PGPEM", credits: 3, grading: "Standard", totalSeats: 75, totalSelected: 65, demandRatio: 0.87, sentiment: "caution", reviewText: "• Recommended only if you have the patience to discuss emotions, feelings, and personal career values extensively.\n• Eccentric teaching style: device usage is strictly prohibited, classes involve skits and drawing on chart paper.\n• Exams are very relaxed and are based entirely on the book authored by the professor herself.", outline: ["Sensemaking, inner sovereignty, managing emotions", "Mindfulness, managing mindsets, stress"], gradingBreakdown: { "CP": "10%", "Take-Home": "20%", "Group Presentation": "20%", "Mid-Term": "25%", "End-Term": "25%" }, sections: [{ id: "LWJ_1", label: "GR1", dayBlock: "FriSat", timeslot: "18:00-19:30", slotIndex: 6, seats: 75, selected: 65, mrb: 0, isDoubleSlot: false }] },
  ...
  { id: "BI", officialCode: "FA703", name: "Behavioral Investing", shortName: "BI", faculty: "Anirudh Dhawan", area: "F&A", anchor: "PGPEM", credits: 3, grading: "Standard", totalSeats: 20, totalSelected: 26, demandRatio: 1.30, sentiment: "recommended", reviewText: "• Highly recommended if you are interested in psychology and how it plays out in trading and investments.\n• The professor is excellent and the course is well-designed. High expectations from group projects.\n• Be prepared for in-class quizzes, which can be a little tricky. Simulations were very fun.", outline: ["Investment biases and approaches to tackle them", "Disposition effect, overconfidence, prevention"], gradingBreakdown: { "CP": "10%", "Trading simulation": "25%", "Quizzes": "30%", "Group project": "35%" }, sections: [{ id: "BI_1", label: "GR1", dayBlock: "FriSat", timeslot: "16:15-17:45", slotIndex: 5, seats: 20, selected: 26, mrb: 52, isDoubleSlot: false }] }
];
      ...
      <div style={{ background: "linear-gradient(135deg, #0f172a 0%, #1e293b 100%)", color: "#fff", padding: "16px 20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <div>
            ...
            <div style={{ fontSize: 13, background: "#1e293b", padding: "6px 12px", borderRadius: 8, marginTop: 8, color: "#cbd5e1", border: "1px solid #334155", display: "inline-block" }}>
              💡 <b>Pro Tip:</b> CCBE, GCK, PSM, PGAI, CB, and RMD are typically offered again in Terms 5 & 6!
            </div>
          </div>
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            >
              {isExporting ? "⏳ Generating..." : "📸 Copy / Share"}
            </button>
